...
We can shorten this dramatically by relying on link:../../../background-information/lambdas.asciidoc[lambdas]:
...
* `note_on` should check the velocity: if it is link:../../../background-information/midi.asciidoc#noteonzerovelocity[zero], you should interpret it as a note off event.
